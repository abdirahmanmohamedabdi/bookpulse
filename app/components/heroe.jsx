  ...
  return (
    ...
    <div className="relative max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <div className="md:ml-auto md:w-1/2 md:pl-10">
        ...
        <p className="mt-2 text-four text-3xl font-extrabold tracking-tight font-font text-one sm:text-4xl">Your Next Great Read is Just a Pulse Away</p>
        ...
        <div className="mt-8">
          <div className="inline-flex rounded-md shadow">
            <a
              href="#"
              className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white text-font bg-one hover:bg-gray-500 font-font"
            >
              Get Started
